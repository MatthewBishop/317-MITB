...
public final class Animable_Sub4 extends Animable {
    ...
    {
        Model model = SpotAnimModel.getModel(aSpotAnim_1592);
        if(model == null)
            return null;
        int j = -1;
        if(aSpotAnim_1592.animation != null)
            j = aSpotAnim_1592.animation.anIntArray353[anInt1593];
        ...
        if(aSpotAnim_1592.breadthScale != 128 || aSpotAnim_1592.depthScale != 128)
            model_1.method478(aSpotAnim_1592.breadthScale, aSpotAnim_1592.breadthScale, aSpotAnim_1592.depthScale);
        model_1.method474(anInt1596);
        model_1.method479(64 + aSpotAnim_1592.ambience, 850 + aSpotAnim_1592.modelShadow, -30, -50, -30, true);
            return model_1;
    }
    ...
    {
        aBoolean1579 = false;
        aSpotAnim_1592 = Graphic.graphics[l2];
        anInt1597 = k1;
        anInt1580 = j2;
        anInt1581 = i2;
        anInt1582 = l1;
    ...
    public void method456(int i)
    {
        ...
        if(aSpotAnim_1592.animation != null)
            for(anInt1594 += i; anInt1594 > aSpotAnim_1592.animation.duration(anInt1593);)
            {
                anInt1594 -= aSpotAnim_1592.animation.duration(anInt1593) + 1;
                anInt1593++;
                if(anInt1593 >= aSpotAnim_1592.animation.anInt352)
                    anInt1593 = 0;
            }
